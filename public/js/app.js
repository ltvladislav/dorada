...
/* harmony import */ var _delta_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delta-functions */ "./resources/js/delta-functions.js");
...
__webpack_require__(/*! slick-carousel */ "./node_modules/slick-carousel/slick/slick.js"); // require("@fancyapps/fancybox");
...
if (!window.site.hasOwnProperty("headerHeight")) {
  var header = document.querySelector('.main-wrapper header');
...
Object(_delta_functions__WEBPACK_IMPORTED_MODULE_0__["createEvent"])(window, 'resize', loadAndResize);
Object(_delta_functions__WEBPACK_IMPORTED_MODULE_0__["createEvent"])(window, 'scroll', function (e) {});

function loadAndResize() {
  Object(_delta_functions__WEBPACK_IMPORTED_MODULE_0__["isExist"])('main', function () {
...
function setEqualHeight(slider, selector) {
  var maxHeight = 0;
  slider.querySelectorAll(selector).forEach(function (slide) {
...
function onOpenModal() {
  ...
  document.documentElement.style.marginRight = "".concat(window.site.scrollBarWidth, "px");
  document.querySelector('header').style.marginRight = "".concat(window.site.scrollBarWidth, "px");
}
...
/***/ "./resources/js/delta-functions.js":
/*!*****************************************!*\
  !*** ./resources/js/delta-functions.js ***!
  \*****************************************/
/*! exports provided: onReady, getElements, createEvent, isTouchDevice, closeOnOutsideClick, scrollToElem, createCookie, readCookie, eraseCookie, objectFitImages, FormValidation, isExist */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeOnOutsideClick", function() { return closeOnOutsideClick; });
...
var defaultConsole = console.warn;
...
var onReady = function onReady(callback) {
  document.readyState === "interactive" || document.readyState === "complete" ? callback() : document.addEventListener("DOMContentLoaded", callback, false);
};
/*********************
...
var getElements = function getElements(parameter) {
  if (typeof parameter === "string" && _typeof(parameter) !== "object" || parameter.constructor === String) {
    try {
...
var createEvent = function createEvent(elements, event, callback) {
  if (getElements(elements)) {
    getElements(elements).forEach(function (item) {
...
function closeOnOutsideClick(event, block, button, activeClass) {
  ...
  var isTargetBlock = checkOutsideClick(event, block, button, activeClass);
...
function checkOutsideClick(event, block, button, activeClass) {
  return block.classList.contains(activeClass) && button.classList.contains(activeClass) && !block.contains(event.target) && !button.contains(event.target);
}
/*********************
...
function scrollToElem(elem) {
  var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.4;
  var offsetRange = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
function objectFitImages(elements, size, needed) {
  if (needed) {
    getElements(elements).forEach(function (item) {
      var src = item.getAttribute("src");

      if (src.length) {
        item.cssText = "background-image: url(".concat(src, ");\n                                background-size: ").concat(size, ";\n                                background-position: center;\n                                background-repeat: no-repeat;");
...
var FormValidation = /*#__PURE__*/function () {
  ...
  _createClass(FormValidation, [{
    ...
    value: function _init() {
      ...
      for (var i = 0; i < this.forms.length; i++) {
        ...
        if (this.forms[i].form && !this.option.submitButton) {
          ...
          this.forms[i].form.querySelector(this.option.submitButton).addEventListener('click', this._onSubmit.bind(this, this.forms[i]));
        }

        for (var j = 0; j < this.forms[i].elements.length; j++) {
    ...
    key: "_onBlur",
    value: function _onBlur(field, e) {
      this.checkField(field);
    }
  }, {
    key: "_onSubmit",
    value: function _onSubmit(item, e) {
      ...
      var trigger = this.constructor.checkStatus(status); // console.log(trigger);
    ...
    value: function checkField(field) {
      try {
        var fieldParams = JSON.parse(field.dataset[this.option.json]),
            fieldStatus = true;
        ...
        if (fieldParams[this.params.dataRequired] !== "false") {
          ...
          fieldStatus = this.checkRequired(_object);
        } else {
          fieldStatus = true;
    ...
    key: "checkRequired",
    value: function checkRequired(data) {
    ...
    key: "checkCharacters",
    value: function checkCharacters(data) {
      var value = data.field.value,
          pattern = /^[\wа-яА-Я`ґєҐЄ´ІіЇї'.,-№\\/\s]{3,}$/;
      var testCharacters = pattern.test(value);
    ...
    key: "checkPassword",
    value: function checkPassword(data) {
      var value = data.field.value,
          pattern = /^[a-z0-9_\+!@;#$%^&*~\(\)\-]{3,20}$/;
      var testPassword = pattern.test(value);
    ...
    key: "checkPhone",
    value: function checkPhone(data) {
      var value = data.field.value,
          pattern = /^((\+)?[1-9]{1,2})?([-\s\.])?((\(\d{1,4}\))|\d{1,4})(([-\s\.])?[0-9 \-\.]{1,12}){1,2}$/;
      var testPhone = pattern.test(value);
    ...
    key: "checkUrl",
    value: function checkUrl(data) {
      var value = data.field.value,
          pattern = /(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;
      var testUrl = pattern.test(value);
    ...
    set: function set(data) {
      var wrapper = data.field.parentElement;
    ...
    get: function get() {
      ...
      document.querySelectorAll(this.option.forms).forEach(function (form) {
        _this.forms.push({
          'form': form
        });
      });
    ...
    get: function get() {
      ...
      var _loop = function _loop(i) {
        _this2.forms[i].elements = [];

        _this2.forms[i].form.querySelectorAll(_this2.option.elements).forEach(function (element, index) {
          _this2.forms[i].elements.push(element);
        });
      };
    ...
    key: "checkStatus",
    value: function checkStatus(formStatus) {
      for (var i = 0; i < formStatus.length; i++) {
        if (!formStatus[i]) {
          return false;
        }
      }
    ...
    key: "removeRequiredMsg",
    value: function removeRequiredMsg(wrapper, className) {
    ...
    key: "removeValidMsg",
    value: function removeValidMsg(wrapper, className) {
      wrapper.classList.remove(className);
    ...
    key: "insertRequiredMsg",
    value: function insertRequiredMsg(data, className) {
      var wrapper = data.field.parentElement; // let errorClass = FormValidation.params.errorClass;
      ...
      if (wrapper.querySelector('.required_message')) {
        wrapper.querySelector('.required_message').addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
    ...
    key: "insertValidMsg",
    value: function insertValidMsg(data, className) {
      var wrapper = data.field.parentElement; // let errorClass = FormValidation.params.errorClass;
      ...
      if (wrapper.querySelector('.valid_message')) {
        wrapper.querySelector('.valid_message').addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
...
function isExist(elements, callback) {
